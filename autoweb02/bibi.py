...
driver.get("https://search.bilibili.com//")    # 打开bibi登录网页
...
#  登录bibi网站
driver.find_element_by_xpath("//*[@id='login-username']").send_keys("17774062894")
driver.find_element_by_xpath("//*[@id='login-passwd']").send_keys("123456")
